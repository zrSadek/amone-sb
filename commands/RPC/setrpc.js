...
\`${prefix}setrpc kali [text]\`➜ **Kali Linux RPC**`))
        ...
        db.rpcdetails = "1774",
        db.rpcstate = "⛧",
        db.rpclargeimage = "https://media.discordapp.net/attachments/1173940367536701470/1174312162131464222/IMG_3346.jpg?ex=6567226d&is=6554ad6d&hm=41614101b6ce8c5ca4567040d3ac0bf8a18861b65c7fe75a2deb69c0232172bd&=&width=559&height=559",
        db.rpcsmallimage = "",
        db.rpcsmallimagetext = "",
        db.rpclargeimagetext = ""
        ...
        db.rpcdetails = "",
        db.rpcstate = "⛧",
        db.rpclargeimage = "https://media.discordapp.net/attachments/1173940367536701470/1174310754107789384/IMG_3347.jpg?ex=6567211d&is=6554ac1d&hm=6f1138cfe0dde405b64f15d67ce1e5c358c6721b5d75ac4d65132fd25f930723&=&width=559&height=559",
        db.rpcsmallimage = "",
        db.rpcsmallimagetext = "",
        db.rpclargeimagetext = ""
        savedb(client, db)
        message.edit(await language(client, "Le status du RPC a été modifié et tu participe a Speed.", "The state of the RPC has been edited and you competing on Speed."))
        rpx()
      }
